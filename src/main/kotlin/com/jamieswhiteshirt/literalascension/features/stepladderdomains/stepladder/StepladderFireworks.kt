...
class StepladderFireworks(name: String, parent: StepladderDomain) : StepladderMaterial(Items.FIREWORKS, name, parent) {
    override fun register() {
        super.register()
        EntityRegistry.registerModEntity(ResourceLocation("literalascension", "flying_stepladder"), EntityFlyingStepladder::class.java, "flying_stepladder", 0, LiteralAscension, 64, 10, true)
    }
