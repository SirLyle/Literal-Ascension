...
abstract class CarvingMaterial(val block: Block, toolLevel: Int, name: String, config: Configuration, override val parent: CarvingMaterials) : SubFeatureCollection<CarvedBlock>(name, parent), ICarvingMaterial {
    ...
    override val suitableToolDamageMultiplier: Int = config.getInt("suitableCarvingToolDamageMultiplier", featureName, 1, 0, 20, "Tool damage multiplier for suitable carving of this material")
    override val unsuitableToolDamageMultiplier: Int = config.getInt("unsuitableCarvingToolDamageMultiplier", featureName, 10, 0, 20, "Tool damage multiplier for unsuitable carving of this material")
