...
class BlockChute(feature: CarvableBlockType) : BlockCarvedBase(feature), ICarvingBehaviour {
    ...
    @Suppress("OverridingDeprecatedMember")
    override fun addCollisionBoxToList(state: IBlockState, world: World, pos: BlockPos, entityBox: AxisAlignedBB, collisionBoxes: MutableList<AxisAlignedBB>, entity: Entity?, isActualState: Boolean) {
