...
class BlockStepladder(val feature: Stepladder) : Block(feature.material), ISpecialLadderBlock {
    companion object {
        ...
        private val collisionBoxesX = arrayOf(
                arrayOf(
                        AxisAlignedBB( 0.0 / 16.0,  0.0 / 16.0, 0.0,  3.0 / 16.0,  8.0 / 16.0, 1.0),
                        AxisAlignedBB(13.0 / 16.0,  0.0 / 16.0, 0.0, 16.0 / 16.0,  8.0 / 16.0, 1.0),
                        AxisAlignedBB( 1.0 / 16.0,  8.0 / 16.0, 0.0,  4.0 / 16.0, 16.0 / 16.0, 1.0),
                        AxisAlignedBB(12.0 / 16.0,  8.0 / 16.0, 0.0, 15.0 / 16.0, 16.0 / 16.0, 1.0)
                ),
                arrayOf(
                        AxisAlignedBB( 2.0 / 16.0,  0.0 / 16.0, 0.0,  5.0 / 16.0,  8.0 / 16.0, 1.0),
                        AxisAlignedBB(11.0 / 16.0,  0.0 / 16.0, 0.0, 14.0 / 16.0,  8.0 / 16.0, 1.0),
                        AxisAlignedBB( 5.0 / 16.0,  5.0 / 16.0, 0.0, 11.0 / 16.0,  8.0 / 16.0, 1.0),
                        AxisAlignedBB( 3.0 / 16.0,  8.0 / 16.0, 0.0,  6.0 / 16.0, 16.0 / 16.0, 1.0),
                        AxisAlignedBB(10.0 / 16.0,  8.0 / 16.0, 0.0, 13.0 / 16.0, 16.0 / 16.0, 1.0)
                ),
                arrayOf(
                        AxisAlignedBB( 4.0 / 16.0,  0.0 / 16.0, 0.0,  7.0 / 16.0,  8.0 / 16.0, 1.0),
                        AxisAlignedBB( 9.0 / 16.0,  0.0 / 16.0, 0.0, 12.0 / 16.0,  8.0 / 16.0, 1.0),
                        AxisAlignedBB( 5.0 / 16.0,  8.0 / 16.0, 0.0, 11.0 / 16.0, 16.0 / 16.0, 1.0)
                )
        )
        private val collisionBoxesZ = arrayOf(
                arrayOf(
                        AxisAlignedBB(0.0,  0.0 / 16.0,  0.0 / 16.0, 1.0,  8.0 / 16.0,  3.0 / 16.0),
                        AxisAlignedBB(0.0,  0.0 / 16.0, 13.0 / 16.0, 1.0,  8.0 / 16.0, 16.0 / 16.0),
                        AxisAlignedBB(0.0,  8.0 / 16.0,  1.0 / 16.0, 1.0, 16.0 / 16.0,  4.0 / 16.0),
                        AxisAlignedBB(0.0,  8.0 / 16.0, 12.0 / 16.0, 1.0, 16.0 / 16.0, 15.0 / 16.0)
                ),
                arrayOf(
                        AxisAlignedBB(0.0,  0.0 / 16.0,  2.0 / 16.0, 1.0,  8.0 / 16.0,  5.0 / 16.0),
                        AxisAlignedBB(0.0,  0.0 / 16.0, 11.0 / 16.0, 1.0,  8.0 / 16.0, 14.0 / 16.0),
                        AxisAlignedBB(0.0,  5.0 / 16.0,  5.0 / 16.0, 1.0,  8.0 / 16.0, 11.0 / 16.0),
                        AxisAlignedBB(0.0,  8.0 / 16.0,  3.0 / 16.0, 1.0, 16.0 / 16.0,  6.0 / 16.0),
                        AxisAlignedBB(0.0,  8.0 / 16.0, 10.0 / 16.0, 1.0, 16.0 / 16.0, 13.0 / 16.0)
                ),
                arrayOf(
                        AxisAlignedBB(0.0,  0.0 / 16.0,  4.0 / 16.0, 1.0,  8.0 / 16.0,  7.0 / 16.0),
                        AxisAlignedBB(0.0,  0.0 / 16.0,  9.0 / 16.0, 1.0,  8.0 / 16.0, 12.0 / 16.0),
                        AxisAlignedBB(0.0,  8.0 / 16.0,  5.0 / 16.0, 1.0, 16.0 / 16.0, 11.0 / 16.0)
                )
        )
    ...
    override fun onBlockActivated(world: World, pos: BlockPos, state: IBlockState, player: EntityPlayer, hand: EnumHand, heldItem: ItemStack?, side: EnumFacing, hitX: Float, hitY: Float, hitZ: Float): Boolean {
        ...
        feature.parent.parent.playLadderPickupSound(world, pos, player)
        return true
    }
